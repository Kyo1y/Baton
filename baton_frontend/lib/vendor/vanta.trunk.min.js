!(function (e, t) {
    ...
    (() => {
        ...
        class d extends p {
            ...
            initP5(e) {
                const i = e.createCanvas(this.width, this.height);
                i.parent(this.el),
                    t.applyCanvasStyles(e.canvas, { background: s(this.options.backgroundColor) }),
                    (this.p5renderer = i),
                    (this.p5canvas = e.canvas),
                    (this.p5 = e);
            }
            restart() {
        ...
        class u extends d {
            ...
            onInit() {
                this.p5 = new l(function (t) {
                    ...
                    (t.setup = function () {
                        this.initP5(t), t.strokeWeight(1), t.stroke(s(this.options.color)), t.smooth(), t.noFill();
                    }),
                        (t.draw = function () {
                            t.clear(),
                                ...
                                (function () {
                                    ...
                                    for (let i = 0; i < o; i++) {
                                        ...
                                        for (let s = 0; s < 360; s++) {
                                            let o = t.radians(s),
                                                n = 
                                                    ( (this.options.chaosMag||20) * this.options.chaos ) * (a(o, (this.options.chaosDelta||.12)*i + (this.options.chaosInit||.2), h) - 7)
                                                    + ((this.options.ringGap||4)*i + (this.options.baseRadius||50))
                                                    + (i*this.options.spacing || 0);
